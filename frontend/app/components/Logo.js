...
/**
 * No lockup deitado a marca vem reduzida — 234 de largura contra os 280,746 da
 * marca solta. É o ajuste que o arquivo faz para o cabeçalho: o wordmark segue
 * no corpo 128 e a marca cede, então o conjunto fica mais baixo sem que a
 * palavra encolha junto. Escala uniforme, não desenho novo.
 */
const HORIZONTAL_MARK_SCALE = 234 / 280.746;
...
const RATIO = {
  ...
  horizontal: { vb: '0 0 738.937 191.704', h: 191.704 / 128, w: 738.937 / 191.704 },
...
export function Logo({ size = 20, variant = 'wordmark', style = {} }) {
  ...
  return (
    ...
    >
      ...
      {variant === 'horizontal' && (
        <>
          <g transform={`scale(${HORIZONTAL_MARK_SCALE})`}>
            <Mark gradientId={gradientId} />
          </g>
          <g transform="translate(247 56.84)">
